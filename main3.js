...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.bakeryNameL.textContent=Game.bakeryName+'\'s bakery III';
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (name.slice(-1).toLowerCase()=='s') name+='\' bakery'; else name+='\'s bakery III';
				...
				{	
					if (Game.prefs.particles)
					{
						...
						if (false)//don't do that
						{
							...
							for (var i=0;i<digits;i++)
							{
								...
								for (var ii=0;ii<num;ii++)
								{
									...
									ctx.drawImage(Pic('bigCookies/3.png'),x-s/2,y-s/2,s,s);
								}
								space+=s/2;
							}
						}
						else
						{
							...
							ctx.drawImage(Pic('bigCookies/3.png'),-s/2,-s/2,s,s);
					...
					else//no particles
					{
						...
						var x=Game.cookieOriginX-s/2;
						var y=Game.cookieOriginY-s/2;
						ctx.drawImage(Pic('bigCookies/3.png'),x,y,s,s);
					}
    ...
    Game.registerMod('Cookieception', {
        init: function() {
            ...
            function addCookieceptionMinigame() {
                ...
                cookieception.data = 'index4.html'
